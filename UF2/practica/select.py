...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:MurMatu@localhost/dbtest'
...
def create_item():
    ...
    new_item = Item(nombre=new_item['nombre'], descripcion=new_item['descripcion'])
...
def update_item(item_id):
    ...
    item.nombre = updated_item['nombre']
    item.descripcion = updated_item['descripcion']
    db.session.commit()
